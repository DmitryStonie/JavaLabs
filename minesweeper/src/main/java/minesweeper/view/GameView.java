...
import minesweeper.model.game.CellFilling;
import minesweeper.model.game.CellUserNote;
...
import minesweeper.observerPattern.Observer;
import minesweeper.observerPattern.TimeObserver;
...
public class GameView implements Observer, TimeObserver {
    ...
    private static final String THIRD_CELL_IMAGE = "/images/cellImages/thirdCellImage.jpg";
    private static final String FOURTH_CELL_IMAGE = "/images/cellImages/fourthCellImage.jpg";
    private static final String FIFTH_CELL_IMAGE = "/images/cellImages/fifthCellImage.jpg";
