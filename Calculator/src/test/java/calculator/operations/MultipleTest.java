...
import ru.nsu.fit.yurin.calculator.operations.Multiple;
...
class MultipleTest {
    ...
    void doOperation() {
        try {
            Operation operation = new Multiple();
            ...
            Double[] answers = {1.3604199235109292e+18, 0.0, 1.531937258676383e+16, 0.0, 2.0};
            double actual;
